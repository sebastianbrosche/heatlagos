...
const OFFERS: {
  ...
  },
  {
    ...
    price: "125",
    description:
      "Unlimited classes billed monthly for 12 months.",
    unit: "month",
  },
  {
...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "Yes. We offer single drop-ins, a 7-day Vacation Week pass, 2 weeks unlimited, and a 2 for 1 intro offer. All make it easy to join while you are visiting Lagos, Luz, Burgau or Portimão.",
  },
];
