...
const TEACHERS: Teacher[] = [
  ...
  },
  {
    ...
    bio: [
      {
        type: "quote",
        text: "If the idea of a yoga class has ever made you quietly nervous, Sebastian is probably exactly the teacher you have been waiting for.",
      },
      {
        type: "paragraph",
      ...
      {
        type: "paragraph",
        text: "That belief lives in the way he teaches. Sebastian brings a rare combination of deep knowledge and genuine humour to every class. He is the kind of teacher who makes the room feel lighter, who takes the practice seriously without taking himself too seriously, and who has a particular gift for making yoga feel completely undaunting to people who have spent their whole lives avoiding it.",
      },
    ],
  },
  {
